...
- 以下是修改线性的属性
   ...
   - lineWidth:指定线条粗细，默认值是1.0，canvas.lineWidth="10";

  ![](/assets/屏幕快照 2016-09-12 下午5.14.56.png)
...
- 属性
  ...
  - lineCap:指定线条端点形状，支持的值有以下三个
   ...
   - **round和square会使线条略变微长**

 ![](/assets/屏幕快照 2016-09-12 下午5.19.02.png)
 ...
 ![](/assets/屏幕快照 2016-09-12 下午5.23.43.png)
